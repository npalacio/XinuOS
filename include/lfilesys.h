...
/* Each of these is 24 bytes long.                                  */
...
/* Size		Object						    */
/*    4		Filesystem "magic" number ("LFSY" or 0x4C465359)    */
/*    4		lfd_dfree					    */
/*    4		lfd_ifree					    */
/*    4		lfd_nfiles					    */
/*  480		20 directory entries, each 24 bytes long	    */
/*   16		16 bytes of padding				    */
/*  ---								    */
/*  512		total; must be 512 to match sector size		    */
/*------------------------------------------------------------------*/

#pragma pack(2)
struct	lfdir	{			/* Entire directory on disk	*/
	char	lfd_magic[4];		/* filesystem magic number	*/
	...
	char	padding[16];		/* Unused chars in directory blk*/
};
#pragma pack()
...
#define LF_CTL_GETDE	F_CTL_GETDE	/* Obtain a directory entry	*/
#define LF_CTL_EXIST	F_CTL_EXIST	/* does local filesystem exist? */
