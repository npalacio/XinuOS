...
/* in file system/remove.c */
extern syscall remove(char *name, uint32 key);

/* in file system/rename.c */
extern syscall rename(char *oldname, char *newname);
...
/* in files uecho*.c */
extern	int32	uechoinit(struct dentry *);
extern	int32	uechoclose(struct dentry *);
extern	int32	uechoget(struct dentry *);
extern	int32	uechocontrol(struct dentry *, int32, int32, int32);
extern	int32	uechoopen(struct dentry *, char *, char *);
extern	status	uechoput(struct dentry *, char);
extern	int32	uechoread(struct dentry *, char *, int32);
