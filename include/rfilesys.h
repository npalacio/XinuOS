...
#ifndef	RF_SERVER_IP
/* was #define	RF_SERVER_IP	"128.10.3.51" */
#define	RF_SERVER_IP	"192.168.1.16"	/* eserver */
#endif
...
#define RFS_CTL_RENAME	F_CTL_RENAME	/* Rename a file		*/
...
#define RF_MSG_NREQ	0x0009		/* Rename request and response	*/
#define RF_MSG_NRES	(RF_MSG_NREQ | RF_MSG_RESPONSE)

#define	RF_MIN_REQ	RF_MSG_RREQ	/* Minimum request type		*/
#define	RF_MAX_REQ	RF_MSG_NREQ	/* Maximum request type		*/
...
#pragma pack(2)
struct  rf_msg_nreq     {               /* remote file rename request   */
        RF_MSG_HDR                      /* header fields                */
        char    rf_nname[RF_NAMLEN];    /* New name for the file        */
};
#pragma pack()

#pragma pack(2)
struct  rf_msg_nres     {               /* remote file rename response  */
        RF_MSG_HDR                      /* header fields                */
};
#pragma pack()
